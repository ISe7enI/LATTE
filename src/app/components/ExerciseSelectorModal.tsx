...
import { Search, Filter, Dumbbell, Star, X, Plus, Check } from 'lucide-react';
...
export function ExerciseSelectorModal({ isOpen, onClose, onSelect, selectedIds = [] }: ExerciseSelectorModalProps) {
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0, y: 50 }}
          className="fixed inset-0 z-50 flex flex-col h-full bg-[#080808]"
        >
          ...
          <AnimatePresence>
            {isFilterOpen && (
              <motion.div
                ...
                className="overflow-hidden bg-[#0a0a0a] border-b border-white/[0.03] z-20 relative flex-shrink-0"
              >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center justify-center">
                      <button 
                        ...
                        className={cn(
                          ...
                          isSelected 
                            ? "bg-[#d3a971] text-black border border-[#d3a971]" 
                            : "bg-white/[0.05] border border-white/[0.1] text-white/40 group-hover:bg-[#d3a971]/20 group-hover:text-[#d3a971] group-hover:border-[#d3a971]/40"
                        )}
                      >
                        {isSelected ? <Check size={16} strokeWidth={2.5} /> : <Plus size={16} />}
                      </button>
                    </div>
                    ...
                    <div className="absolute right-4 top-3 flex items-center">
                      ...
                      >
                        <Star size={12} className={isFav ? "fill-[#d3a971] text-[#d3a971]" : ""} />
                      </button>
                    </div>
                  </motion.div>
                );
